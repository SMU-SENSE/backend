...
public class DevicePairingService {
 ...
 public DevicePairingService(DevicePairingSessionRepository sessions,AacDeviceRepository devices,AacUserRepository users,AacUserAccessService access,GuardianAccessService guardianAccess,PairingHashService hashes,DeviceAuthService deviceAuth,@Value("${app.pairing.qr-prefix:malmoa://pair?token=}")String qrPrefix){this.sessions=sessions;this.devices=devices;this.users=users;this.access=access;this.guardianAccess=guardianAccess;this.hashes=hashes;this.deviceAuth=deviceAuth;this.qrPrefix=qrPrefix;}
